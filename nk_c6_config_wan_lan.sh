...
\mv -f /etc/sysconfig/network-scripts/ifcfg-${lanif} /etc/sysconfig/network-scripts/ifcfg-${lanif}.bak
...
echo "DEVICE=${lanif}" >> /etc/sysconfig/network-scripts/ifcfg-${lanif}
echo "ONBOOT=yes" >> /etc/sysconfig/network-scripts/ifcfg-${lanif}
echo "BOOTPROTO=static" >> /etc/sysconfig/network-scripts/ifcfg-${lanif}
echo "IPADDR=${lanip}" >> /etc/sysconfig/network-scripts/ifcfg-${lanif}
echo "NETMASK=255.255.255.0" >> /etc/sysconfig/network-scripts/ifcfg-${lanif}
